...
/// free to load; MTA's ~496, NJT rail's ~172, and NJT bus's ~5k (already
/// filtered to a NYC-metro core - see build_njt_bus_stops.py) come from
/// bundled CSV parses, the only meaningfully async part of this.
